...
parser = argparse.ArgumentParser(description='Train STCANet3D')
# Datasets
...
# Augment
parser.add_argument('--seq_len', type=int, default=4, help="number of images to sample in a tracklet") #seq_len = 8, 15
parser.add_argument('--sample_stride', type=int, default=8, help="stride of images to sample in a tracklet")
parser.add_argument('--test_frames', default=4, type=int, help='frames/clip for test') #check
...
parser.add_argument('--stepsize', default=[40,80,120], nargs='+', type=int,
                    help="stepsize to decay learning rate") #[40,80,120]
parser.add_argument('--gamma', default=0.1, type=float,
                    help="learning rate decay") #defaukt = 0.1
...
def main():
    ...
    #scheduler = WarmupMultiStepLR(optimizer, args.stepsize, args.gamma,0.001,10,'linear')
